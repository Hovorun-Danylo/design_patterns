...
// region Diets
export const HerbivoreDiet = Catalogue.create((FoodType), {
...
export const CarnivoreSpecies = Catalogue.create((AnimalType), {
...
export const OmnivoreSpecies = Catalogue.create((AnimalType), {
